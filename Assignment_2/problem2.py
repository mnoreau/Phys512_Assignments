...
#This is just a counter for function calls
def integrate_adaptive(fun, a, b, tol, extra=None):
        ...
        #We split our integral in two and evaluate it
                ...
                lmid, flmid, left = simpsons(f, a, fa, mid, fmid) #simpsons(f,a,fa,mid,fmid)
                rmid, frmid, right = simpsons(f, mid, fmid, b, fb) #simpsons(f,mid,fmid, b, fb)
